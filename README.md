...
- **2025-03-28** - [HomeBot Plus](docs/更新记录.md#2025-03-28---homebot-plus-版本发布)：新增升降平台功能，支持机械臂整体高度调节
- **2025-03-24** - [语音交互与视觉理解](docs/更新记录.md#2025-03-24---语音交互与视觉理解)：新增语音交互系统、视觉理解功能、电池状态监测
