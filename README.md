...
- **2026-03-28** - [HomeBot Plus](docs/更新记录.md#2026-03-28---homebot-plus-版本发布)：新增升降平台功能，支持机械臂整体高度调节
- **2026-03-24** - [语音交互与视觉理解](docs/更新记录.md#2026-03-24---语音交互与视觉理解)：新增语音交互系统、视觉理解功能、电池状态监测

📋 [查看完整更新记录](docs/更新记录.md)
...
```bash
cd software
python tools/calibrate_arm.py
```

按提示将机械臂各关节移动到零点位置，完成后校准数据会自动保存。

👉 详细说明请查看 [工具脚本使用指南](docs/工具脚本使用指南.md#机械臂校准工具)
